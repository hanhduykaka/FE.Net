       ...
       window.AjaxDungChung
            ...
            (function(data) {
                if (data) {
                    ...
                    var url = data.TabID + '/moduleId/' + data.ModuleID + '/linhVucId/' + 2 + '/thuTucId/' + 22
    ...
    var tblDataTable = $(tableid).DataTable
       ({
           ...
           'createdRow': function (row, data) {
               $(row).attr('data-id', data.ChungChiDuocID);
               $(row).attr('data-sochungchi', data.SoChungChi);
               $(row).attr('data-trangthaiid', data.TrangThaiGiayPhepID);
           },
           'lengthChange': true,
           "ordering": false,
           'searching': false,
...
$(document).on('click', "tbody .xem_chi_tiet", (e) => {
    ...
    var trangthaiid = parentTr.attr("data-trangthaiid");
    if (trangthaiid = !2)
        return;
...
((e) => {
    ...
    window.AjaxDungChung
       ("post",
         "/DesktopModules/MVC/NghiepVu/NganhDuoc/NganhDuoc_CC_Duoc_XuatDanhSach",
           window.moduleId,
           window.tabId,
           $("input[name='__RequestVerificationToken']").val(),
           request,
...
((e) => {
    ...
    window.AjaxDungChung
       ("post",
         "/DesktopModules/MVC/NghiepVu/NganhDuoc/NganhDuoc_CC_Duoc_CongBoWebsite",
           window.moduleId,
           window.tabId,
           $("input[name='__RequestVerificationToken']").val(),
           request,
